...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    sublabel: 'Apartamento · Casa · Família · Animais de estimação',
    accent: '#4ADE80',
    ...
    tags: ['Bem-vindo', 'Nome da família', 'Pets', 'Frases personalizadas'],
  ...
  },
  {
    id: 'seguranca',
    tag: 'SEGURANÇA',
    title: 'Segurança e alto tráfego',
    sublabel: 'Condomínios · Corredores · Hospitais · Indústria',
    accent: '#94A3B8',
    accentRgb: '148,163,184',
    cardBg: '#080B0F',
    previewBg: '#0D1117',
    previewLabel: 'ANTI',
    previewSub: 'DERRAPANTE',
    tags: ['Liso preto', 'Liso cinza', 'Antichamas', 'Por metro linear'],
    cta: { text: 'Consultar disponibilidade', href: WPP('Olá! Preciso de capachos antiderrapantes para área de alto tráfego. Quais opções vocês têm?'), external: true },
  },
]
